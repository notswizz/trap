      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between">
        ...
        {user ? (
          <div className="flex items-center space-x-2 sm:space-x-4">
            <div className="flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-full border border-indigo-200 shadow-sm">
              <span className="text-gray-500 text-xs sm:text-sm mr-1 sm:mr-2">Tokens:</span>
              <span className="font-semibold text-base sm:text-lg bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                {getBalance()}
              </span>
            </div>
            <div className="hidden sm:flex items-center gap-1 px-4 py-1.5 bg-gradient-to-r from-indigo-100/80 to-purple-100/80 rounded-full border border-indigo-200/50 shadow-sm hover:shadow-md transition-shadow">
          ...
          <button
            ...
            className="px-4 sm:px-6 py-2 sm:py-2.5 rounded-full bg-indigo-600 text-white text-sm sm:text-base font-medium
